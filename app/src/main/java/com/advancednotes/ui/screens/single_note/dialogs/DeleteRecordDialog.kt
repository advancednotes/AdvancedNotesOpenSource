...
fun DeleteRecordDialog(
    ...
    MyAlertDialog(
        opened = deleteRecordDialogState.opened,
        onDismissRequest = {
            onCloseDialog()
        },
        confirmButton = {
        ...
        title = stringResource(id = R.string.delete_note_record_title),
        content = { MyText(text = stringResource(id = R.string.delete_note_record_text)) }
    )
}